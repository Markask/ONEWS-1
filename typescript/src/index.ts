...
import { DvCodedText, DvCount } from 'ehrcraft-form-api';
...
export function main(api: API) {
  ...
  console.log(banner)
     ...
     // Create a function getYellowValue or something that has access to the relevant fields
    ...
    function setRedAndYellow(api: API){
      console.log("the setRedAndYellow function was triggered")
      
      const yellowValue = new DvCount();
      yellowValue.Magnitude = 0; 
      //console.log("before yellow", yellowValue.Magnitude)

      const redValue = new DvCount();
      redValue.Magnitude = 0;
      //console.log("before red", redValue.Magnitude)
